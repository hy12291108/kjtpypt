	 ...
	 <table id="contentTable" class="table  table-bordered  ">
		<tbody>
			...
			<tr>
						...
						<td>
							<input name="checkPersonP" type="text" value="${threeArea.checkPersonP}" readonly>
						</td>
						<td><lable>审核时间:</lable></td>
						<td>
							<input name="checkTimeP" type="text" value="${threeArea.checkTimeP}" readonly>
						</td>
				...
				<tr>
						...
						<lable>审核意见:</lable></td>
						<td  colspan="5">
							<textarea name="checkAdviceP" rows="3"  placeholder="审核意见" style="width:1024px" required></textarea>
							<span class="help-inline"><font color="red">*</font></span>
						</td>
				</tr>
		</tbody>
