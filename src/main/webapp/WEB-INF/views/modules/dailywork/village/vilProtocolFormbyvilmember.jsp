...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a>贫困村个人协议添加</a></li>
	</ul><br/>
	<!-- 2019-04-23原方法（savevilprotocolBymember），新方法（savevilprotocolBypersonal） -->
	<form:form id="inputForm" modelAttribute="teamMember" action="${ctx}/dailywork/village/vilProtocol/savevilprotocolBypersonal" method="post" class="form-horizontal" enctype="multipart/form-data">
		<form:hidden path="id"/>
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="5">
					<br>
				    <a href="${ctx}/dailywork/tpy/downloadFile?name=Kjtptyfwxy.doc" style="color: red">个人服务协议模板</a><br>
					<br>
				</td>				
			</tr>
			<tr>
				<td class="tit"><lable>个人协议上传:</lable></td>
				<td colspan="5">
					<br>
