...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>个人服务协议查看(贫困村)</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="teamMember" action="${ctx}/dailywork/village/vilProtocol/saveshvilprotocolBymember" method="post" class="form-horizontal" enctype="multipart/form-data">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table id="contentTable" class="table-form">
		<tbody>
			<tr>
					<td colspan="5"><h4>个人协议信息</h4></td>
			</tr>
			<tr>
			...
			<tr>			
				...
				<td>
					<form:input  readonly="true"  path="checkPerson1" htmlEscape="false" maxlength="64" class="input-xlarge"/>
				</td>
				<td class="tit"><lable>审核时间:</lable></td>
				<td>
					<form:input  readonly="true"  path="checkTime1" htmlEscape="false" maxlength="64" class="input-xlarge"/>
				</td>
			</tr>
			<tr>	
				<td class="tit"><lable>是否通过:</lable></td>
				<td>
					<form:input  readonly="true"  path="memberprotocolFlag" htmlEscape="false" maxlength="64" class="input-xlarge"/>										
				</td>			
				<td class="tit"><lable></lable></td>
				<td>
				</td>				
			...
			<tr>
				...
				<td colspan="5">
					<form:textarea path="checkOpinion1" htmlEscape="false" rows="4" maxlength="1000" style="width:1120px" class="required"/>
				</td>
			</tr>
		<tbody>
		</table>	
