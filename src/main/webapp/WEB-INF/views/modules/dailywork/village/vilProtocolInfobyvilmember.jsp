...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>贫困村个人协议查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="teamMember" action="${ctx}/dailywork/village/vilProtocol/savevilprotocol" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<tbody>
			...
			<tr>
				<td class="tit"><lable>个人服务协议:</lable></td>
				<td colspan="5">
					<br>
			...
			<tr>
				...
				<td colspan="5">
					<form:textarea path="checkOpinion1" htmlEscape="false" readonly="true" rows="4" maxlength="200" style="width:1120px"/>
				</td>
			</tr>
		<tbody>
		</table>	
