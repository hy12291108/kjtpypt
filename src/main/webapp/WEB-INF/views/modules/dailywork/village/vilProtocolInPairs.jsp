...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/dailywork/village/vilProtocol/");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
		...
		<li class="active"><a href="${ctx}/dailywork/village/vilProtocol/">待上传服务对象协议列表</a></li>
		<li><a href="${ctx}/dailywork/village/vilProtocol/list">已上传服务对象协议列表</a></li>
		</ul>
		<form:form id="searchForm" modelAttribute="sqtpy" action="${ctx}/dailywork/village/vilProtocol/" method="post" class="breadcrumb form-search ">
