	...
	<ul class="nav nav-tabs">
		<c:choose>
			<c:when test="${tpyAnnualreport.html=='verify'||tpyAnnualreport.html=='verifyView'}">
					<li><a href="${ctx}/dailywork/tpy/tpyAnnualreportVerify/">年度考核待审核列表</a></li>
			...
			<c:otherwise>
				<li><a href="${ctx}/dailywork/tpy/tpyAnnualreport/">特派员年度考核列表</a></li>
				<li class="active"><a href="${ctx}/dailywork/tpy/tpyAnnualreport/view?id=${tpyAnnualreport.id}">特派员年度考核查看</a></li>
			</c:otherwise>
		</c:choose>	
		...
		<fieldset>
			<table class="table-form">
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="repYearsummary" readonly="true" class="required" rows="5" cssStyle="width:1020px"/>
					</td>
				</tr>					
				<tr>
				...
				<tr>
					<td class="tit">审核</td>
					<td colspan="2">
					<form:select path="repStatus" class="input-xlarge " cssStyle="width:220px">
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="repApproopinion" class="required" rows="5" cssStyle="width:1020px"/>
					</td>
				</tr>					
			</table>
		</fieldset>
