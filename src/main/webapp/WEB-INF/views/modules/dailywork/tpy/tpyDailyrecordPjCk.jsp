...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/dailywork/tpy/tpyDailyrecord/savepj">查看评价信息</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="tpyDailyrecord" action="${ctx}/dailywork/tpy/tpyDailyrecord/savepj" method="post" class="form-horizontal">
		...
		<table class="table-form">
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="recHelpContent"  readonly="true" class="required" rows="5" maxlength="200" cssStyle="width:900px"/>
					</td>
				</tr>		
				<tr>
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="recApproopinion" readonly="true" class="required" rows="5" maxlength="200" cssStyle="width:900px"/>
					</td>
				</tr>	
				<tr>
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="fwdxpjYj" readonly="true" rows="4" maxlength="1000" cssStyle="width:900px"/>
					</td>
				</tr>					
			</table>
