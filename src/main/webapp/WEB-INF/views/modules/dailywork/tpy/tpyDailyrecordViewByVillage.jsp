	...
	<form:form id="inputForm" modelAttribute="tpyDailyrecord"
		...
		<table class="table-form">	
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="recHelpContent"  readonly="true" class="required" rows="5" cssStyle="width:800px"/>
					</td>
				</tr>
				<tr>
			...
			<tr>
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="recApproopinion" readonly="true" class="required" rows="5" cssStyle="width:800px"/>
					</td>
				</tr>
				<tr>
