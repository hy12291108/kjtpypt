...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/dailywork/tpy/tpyDailyrecord/dpjlist");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/dailywork/tpy/tpyDailyrecord/dpjlist">待评价列表</a></li>
		<li><a href="${ctx}/dailywork/tpy/tpyDailyrecord/ypjlist">已评价列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tpyDailyrecord" action="${ctx}/dailywork/tpy/tpyDailyrecord/dpjlist" method="post" class="breadcrumb form-search ">
			...
			<tr>
				...
				<td><c:choose>
						...
						<c:when test="${tpyDailyrecord.recStatus == 'pass'}">
							<a href="${ctx}/dailywork/tpy/tpyDailyrecord/pj?id=${tpyDailyrecord.id}">评价</a>
						</c:when>
