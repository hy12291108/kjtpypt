...
<body>
	<ul class="nav nav-tabs">
		...
		<fieldset>
			<legend>特派员日志(贫困村)填报信息22</legend>
			<table class="table-form">							
				...
				<tr>
					<td class="tit">年度</td>
					<td colspan="2">
					<form:input path="Year" readonly="true" class="Wdate" htmlEscape="false" maxlength="50" cssStyle="width:210px" onclick="WdatePicker({dateFmt:'yyyy'+'年',isShowClear:false});"/>
					</td>
				...
				<tr>
					...
					<td colspan="2">
					<form:input path="teamName" readonly="true" htmlEscape="false" maxlength="50" cssStyle="width:210px"/>
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="recHelpContent" class="required" rows="5" cssStyle="width:900px"/>
					</td>
				</tr>
				<tr>
			...
			<form:input path="recTpyLocation" type="hidden"/>
