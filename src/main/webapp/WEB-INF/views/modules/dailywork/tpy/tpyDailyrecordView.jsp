		...
		<table class="table-form">	
			<tr>
				...
				<tr>
					...
					<td colspan="2"><form:input path="IsThreeArea" readonly="true" htmlEscape="false" maxlength="50" cssStyle="width:210px"/></td>					
				</tr>
				<tr>
					...
					<form:input path="dailyRecordType" readonly="true" htmlEscape="false" maxlength="50" cssStyle="width:150px"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="4">
						<form:textarea path="recHelpContent"  readonly="true" class="required" rows="4" maxlength="1000" cssStyle="width:800px"/>
					</td>
				</tr>
				<tr>
			...
			<tr>
				...
				<tr>
					...
					<td colspan="4">
						<form:textarea path="recApproopinion" readonly="true" class="required" rows="4" maxlength="1000" cssStyle="width:800px"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="5">
						<form:textarea path="fwdxpjYj" readonly="true" rows="4" maxlength="1000" cssStyle="width:800px"/>
					</td>
				</tr>							
			</table>
