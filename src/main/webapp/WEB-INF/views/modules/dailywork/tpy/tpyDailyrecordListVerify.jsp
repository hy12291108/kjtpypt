  ...
  <head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/dailywork/tpy/tpyDailyrecordVerify");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/dailywork/tpy/tpyDailyrecordVerify">工作日志未审批列表</a></li>
		<li><a href="${ctx}/dailywork/tpy/tpyDailyrecordVerify/YshList">工作日志已审批列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tpyDailyrecord" action="${ctx}/dailywork/tpy/tpyDailyrecordVerify" method="post" class="breadcrumb form-search ">
