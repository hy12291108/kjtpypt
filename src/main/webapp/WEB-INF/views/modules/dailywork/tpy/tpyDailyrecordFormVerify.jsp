...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/dailywork/tpy/tpyDailyrecordVerify/form?id=${tpyDailyrecord.id}">工作日志信息审核</a>
		</li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="tpyDailyrecord" action="${ctx}/dailywork/tpy/tpyDailyrecordVerify/save" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<table class="table-form">
				...
				<tr>
					...
					<td colspan="4">
						<form:textarea path="recHelpContent"  readonly="true"  rows="4" cssStyle="width:800px"/>
					</td>
				</tr>	
				<tr>
			...
			<tr>
				...
				<tr>
					...
					<td colspan="4">
						<form:textarea path="recApproopinion" class="required" rows="4" cssStyle="width:800px"/>
					</td>
				</tr>					
			</table>
