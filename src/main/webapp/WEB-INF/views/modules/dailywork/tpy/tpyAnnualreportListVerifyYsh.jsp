...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/dailywork/tpy/tpyAnnualreportVerify/YshTpyAnnualreportlist");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/dailywork/tpy/tpyAnnualreportVerify/YshTpyAnnualreportlist">年度考核已审核列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tpyAnnualreport" action="${ctx}/dailywork/tpy/tpyAnnualreportVerify/YshTpyAnnualreportlist" method="post" class="breadcrumb form-search ">
