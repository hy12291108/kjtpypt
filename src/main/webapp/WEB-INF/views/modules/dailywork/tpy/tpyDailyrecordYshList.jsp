...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/dailywork/tpy/tpyDailyrecord/yshlist");
			$("#searchForm").submit();
	    	return false;
	    }
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/dailywork/tpy/tpyDailyrecord/yshlist">工作日志已审核列表</a></li>	
		<li><a onclick="centermenu7()">日志添加</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tpyDailyrecord" action="${ctx}/dailywork/tpy/tpyDailyrecord/yshlist" method="post" class="breadcrumb form-search ">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th class="sort-column recHelpobjtype">帮扶对象</th>
				<th class="sort-column recStartTime">帮扶开始时间</th>
				<th class="sort-column recEndTime">帮扶结束时间</th>
				<th class="sort-column recWrittenTime">填写时间</th>
				<th>日志类型</th>
