...
<body>	
	<ul class="nav nav-tabs">
		<li class="active">服务对象申请特派员信息(法人)</li>
	</ul>
	<form:form id="inputForm" modelAttribute="sqtpy" action="${ctx}/sqtpy/tpy/saveshtpy" method="post" class="form-horizontal">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form:input path="tpyinfo.office.name" readonly="true" htmlEscape="false" id="zhicheng" maxlength="100"/>				
				</td>
			</tr>
			<tr>
				<td class="tit"><lable>法人:</lable></td>
				<td>
			...
			<tr>
				...
				<td colspan="5">
					<form:textarea path="tpyinfo.corpScale" htmlEscape="false" rows="4" readonly="true" maxlength="1000" style="width:900px" id="zytc"  class="required"/>
				</td>
			</tr>
			<tr>
				<td class="tit"><lable>科技优势与营业范围:</lable></td>
				<td colspan="5">
					<form:textarea path="tpyinfo.corpMajor" htmlEscape="false" rows="4" readonly="true" maxlength="1000" style="width:900px" id="zytc"  class="required"/>
				</td>
			</tr>
			<tr>			
			...
			<tr>
				...
				<td colspan="3">
					<form:textarea path="zpryj" readonly="true" htmlEscape="false" rows="4" style="width:900px" maxlength="1000" class="required"/>
				</td>						
			</tr>
		<tbody>
		</table>
