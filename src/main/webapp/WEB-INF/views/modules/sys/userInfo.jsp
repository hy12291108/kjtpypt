...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<div class="control-group">
			<label class="control-label">管辖机构:</label>
			<div class="controls">
				<label class="lbl">${user.company.name}</label>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">直属部门:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="email" htmlEscape="false" value="${user.email}" maxlength="50" class="email"/>
			</div>
		</div>
		<div class="control-group">
