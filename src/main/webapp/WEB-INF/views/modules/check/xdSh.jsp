...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/UserSh/xdShForm");
			$("#searchForm").submit();
	    	return false;
	    }
	</script>
...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/UserSh/xdShForm">待审核服务对象</a></li>
		<li><a href="${ctx}/UserSh/passXd?flag=2">已通过服务对象</a></li>
		<li><a href="${ctx}/UserSh/passXd?flag=1">未通过服务对象</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="user" action="${ctx}/UserSh/xdShForm" method="post" class="breadcrumb form-search ">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>省份</th><th>部门</th><th>登录名</th><th class="sort-column name">单位名称</th><th>联系人姓名</th><th>联系人电话</th><th>操作</th></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<shiro:hasPermission name="sys:user:edit"><td>
    				<a href="${ctx}/UserSh/xdInfoSh?id=${user.id}">审核</a>
