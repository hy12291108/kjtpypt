...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="<c:url value='${fns:getAdminPath()}/cms/article/xxydform?id=${article.id}&category.id=${article.category.id}'><c:param name='category.name' value='${article.category.name}'/></c:url>">学习园地文章添加</a></li>
	</ul><br/>
