        ...
        <form:form id="inputForm" modelAttribute="user" action="${ctx}/UserRegister/tempSave" method="post" class="form-horizontal">
            <table class="table  table-bordered">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="name" name="name" placeholder="请输入企业名称" type="text" value="" maxlength="10"
                               minlength="2"/>
                        <span class="help-inline"><font color="red">*</font></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <form:input path="mobile" id="mobile" readonly="true" htmlEscape="false" placeholder="请输入密码"  maxlength="100"/>
                        <span class="help-inline"><font color="red">*</font></span>
                    </td>
                </tr>
            </table>
            <input name="loginFlag" value="1" type="hidden"/>
            <input name="personFlag" value="6" type="hidden"/>
