...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/UserRegister/temporaryLogin" method="post">
		...
		<a class="btn btn-large" href="/kjtpypt/a/UserRegister/temporary">前往注册</a>
		<%-- <label for="rememberMe" title="下次不需要再登录"><input type="checkbox" id="rememberMe" name="rememberMe" ${rememberMe ? 'checked' : ''}/> 记住我（公共场所慎用）</label> --%>
	</form>
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="#" target="_blank">协同数码股份有限公司</a> ${fns:getConfig('version')} 
	</div>
	</div>
</body>
</html>