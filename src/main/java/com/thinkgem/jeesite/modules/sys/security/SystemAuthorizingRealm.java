	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		if (user != null) {
			if (Global.NO.equals(user.getLoginFlag())){
				throw new AuthenticationException("msg:该帐号已禁止登录或不能登录.");
			}/*//@author刘钢 20170731
			else if("0".equals(user.getCheckFlag())){
				throw new AuthenticationException("msg:该账号尚未审核，请等待。。。.");
			}else if("1".equals(user.getCheckFlag())){
				throw new AuthenticationException("msg:该账号审核未通过");
			}*/
