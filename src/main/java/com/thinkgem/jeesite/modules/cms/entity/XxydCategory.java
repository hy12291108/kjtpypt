 ...
 * @version 2013-05-15
 */
public class XxydCategory extends DataEntity<XxydCategory> {
...
//	private Integer sort; 		// 排序（升序）
	...
	private List<XxydCategory> childList = Lists.newArrayList(); 	// 拥有子分类列表
	...
	public XxydCategory(String id){
		this();
		this.id = id;
	}
	
	public XxydCategory(String id, Site site){
		this();
		this.id = id;
		this.setSite(site);
	}
...
//	}
	...
	public List<XxydCategory> getChildList() {
		return childList;
	}

	public void setChildList(List<XxydCategory> childList) {
