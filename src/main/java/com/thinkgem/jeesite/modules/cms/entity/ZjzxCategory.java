 ...
 * @version 2013-05-15
 */
public class ZjzxCategory extends DataEntity<ZjzxCategory> {
...
//	private Integer sort; 		// 排序（升序）
	...
	private List<ZjzxCategory> childList = Lists.newArrayList(); 	// 拥有子分类列表
	...
	public ZjzxCategory(String id){
		this();
		this.id = id;
	}
	
	public ZjzxCategory(String id, Site site){
		this();
		this.id = id;
		this.setSite(site);
	}
...
//	}
	...
	public List<ZjzxCategory> getChildList() {
		return childList;
	}

	public void setChildList(List<ZjzxCategory> childList) {
