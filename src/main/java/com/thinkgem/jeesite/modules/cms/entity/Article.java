...
public class Article extends DataEntity<Article> {
	...
	private XxydCategory xxydcategory;// 分类编号
	private ZjzxCategory zjzxcategory;// 分类编号
    ...
    private String attachment; //附件关联文章id
    ...
    public ZjzxCategory getzjzxcategory() {
		return zjzxcategory;
	}

	public void setZjzxcategory(ZjzxCategory zjzxcategory) {
		this.zjzxcategory = zjzxcategory;
	}
	
	public XxydCategory getXxydcategory() {
		return xxydcategory;
	}

	public void setXxydcategory(XxydCategory xxydcategory) {
		this.xxydcategory = xxydcategory;
	}
